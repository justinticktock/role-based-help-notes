...
$rbhn_settings = 	apply_filters( 'rbhn_settings', 
						array(								
							'rbhn_general' => array(
...
if ( ! isset( $rbhn_tabbed_settings_instance )) {
...
// Add new settings functions to the Tabbed_Settings Class within the tabbed settings object for this plugin..

if ( class_exists( 'RBHN_Settings_Additional_Methods' )) {

	$rbhn_tabbed_settings_instance->registerHandler( new RBHN_Settings_Additional_Methods() );
